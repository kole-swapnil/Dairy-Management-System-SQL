<?php
    ...
    if(isset($_POST['farm_id']) && isset($_POST['location']) && isset($_POST['dairy_produced']) && isset($_POST['farmer_id']))
        {
            $stmt = $pdo->prepare("UPDATE farm SET location = :loc,dairy_produced = :pro,farmer_id = :fid WHERE farm_id = :cid");
            $stmt->execute(array(':loc' => $_POST['location'],':pro' => $_POST['dairy_produced'],':fid' => $_POST['farmer_id'],':cid' => $_POST['farm_id']));
...
V
	<div class="contact1">
		<div class="container-contact1">
            ...
            <form method = "post" action = "editfarm.php" class="contact1-form validate-form">
                ...
                <div class="wrap-input1">
					<input class="input1" type="text" name="farmer_id" value="<?= $row['farmer_id'] ?>">
                    <span class="shadow-input1"></span>
                </div>
