<?php
    ...
    if(isset($_POST['customer_id']) && isset($_POST['name']) && isset($_POST['Aadhar']))
        {
            $stmt = $pdo->prepare("UPDATE customer SET name = :name,Aadhar = :aad WHERE customer_id = :cid");
            $stmt->execute(array(':name' => $_POST['name'],':aad' => $_POST['Aadhar'],':cid' => $_POST['customer_id']));
